...
public:
    ...
    void displayfte()
    {
        ...
        cout<<r7;
        cout<<endl;
        cout<<"\n\t\t "<<r1<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r4<<"BENNETT UNIVERSITY (TIMES OF INDIA)"<<endl;
        cout<<"\t\t "<<r6<<"    BU    "<<r6<<"FACULTY OF ENGINEERING AND TECHNOLOGY,\n";
        cout<<" \t\t "<<r2<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r3<<"GREATER NOIDA.\n";
...
public:
    ...
    void result(string id)
    {
        ...
        for(int i=1;i<10;i++)
            cout<<r5;
        cout<<r12<<" "<<r6<<endl;
        cout<<"\t"<<r6<<" "<<r6<<" CSET101     SE              "<<r6<<"     "<<credits[0]<<"     "<<r6<<"   "<<setw(3)<<marks[0]<<"   "<<r6<<"   "<<gr[0]<<gr[0]<<"    "<<r6<<" "<<r6<<endl;
        cout<<"\t"<<r6<<" "<<r6<<" CSET102     P&S             "<<r6<<"     "<<credits[1]<<"     "<<r6<<"   "<<setw(3)<<marks[1]<<"   "<<r6<<"   "<<gr[1]<<gr[1]<<"    "<<r6<<" "<<r6<<endl;
        cout<<"\t"<<r6<<" "<<r6<<" CSET103     C++             "<<r6<<"     "<<credits[2]<<"     "<<r6<<"   "<<setw(3)<<marks[2]<<"   "<<r6<<"   "<<gr[2]<<gr[2]<<"    "<<r6<<" "<<r6<<endl;
        cout<<"\t"<<r6<<" "<<r6<<" CSET105     IMS             "<<r6<<"     "<<credits[3]<<"     "<<r6<<"   "<<setw(3)<<marks[3]<<"   "<<r6<<"   "<<gr[3]<<gr[3]<<"    "<<r6<<" "<<r6<<endl;
        cout<<"\t"<<r6<<" "<<r6<<" CSET106     MIPS            "<<r6<<"     "<<credits[4]<<"     "<<r6<<"   "<<setw(3)<<marks[4]<<"   "<<r6<<"   "<<gr[4]<<gr[4]<<"    "<<r6<<" "<<r6<<endl;
         cout<<"\t"<<r6<<" "<<r2;
        for(int i=1;i<30;i++)
            cout<<r5;
        cout<<r8;
        ...
        case 0:
            {
                char x=221,y=222;
                cout<<"\n\n\n\n\n\n\n\n";
                cout<<"\t\t\t\t    "<<x<<" THANK YOU FOR USING CollegeTheka \a"<<y;
